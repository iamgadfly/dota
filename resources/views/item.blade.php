        ...
        <div class="skins-market-view" itemscope="" itemtype="http://schema.org/Product">
            ...
            <div class="market-skin-preview">
                ...
                <div class="skin-info">
                    ...
                    <div class="skin-name">{{$data['item_data']->name }}</div>
            ...
            <div class="section-block about-block">
                ...
                <span><p>Используется: Invoker<br>Плащ церемониального боевого наряда канувшей в небытие академии тайных искусств. Один из ее лучших учеников взял этот наряд в качестве священного дара, покидая опостылевшие ему стены.</p>

</span>
                <div style="display: none" itemprop="description">В нашем магазине вещей вы можете купить Dark Artistry
