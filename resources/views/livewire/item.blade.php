            ...
            <div class="page-header small">
                <div class="bread" itemscope="" itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <svg class="breadcrumb-icon">
                        <use xlink:href="/assets/images/sprite.svg?id=274205d7043ac7331d0d0bb072720d70#right-icon">
                        </use>
                    </svg>
                ...
                <h1 style="margin-top: 50px;">{{ $item->name }}</h1>
            </div>
            ...
            <div class="wrap">
                <div class="skins-market-view" itemscope="" itemtype="http://schema.org/Product">
                    ...
                    <div itemprop="image" itemscope="" itemtype="https://schema.org/ImageObject">
                        <meta itemprop="url contentUrl" content="{{ str_replace('"', '', $item->image) }}">
                    </div>
                    ...
                    <div class="market-skin-preview">
                        <div class="image-block" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                            ...
                            <a href="{{ str_replace('"', '', $item->image) }}" data-lightbox="group"
                                title="Dark Artistry Cape">
                                <img src="{{ str_replace('"', '', $item->image) }}" class="image" alt="Dark Artistry Cape"
                            ...
                            <div class="skin-min-price">
                                ...
                                <div class="min-price-buttons">
                                    <div class="buy-now buy-now-button" data-id="96844419"
                                         onclick="addToCart({{$item}})"
                                         wire:click="addToStart({{ $item->classid }})">Купить сейчас
                                    </div>
